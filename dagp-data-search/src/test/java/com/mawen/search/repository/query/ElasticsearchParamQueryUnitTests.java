...
class ElasticsearchParamQueryUnitTests extends ElasticsearchQueryUnitTestBase {
	...
	void shouldParseSingleNestedQueryCorrectly() throws NoSuchMethodException {
		...
		assertThat(criteria.getNestedCriteria().size()).isEqualTo(2);
	...
	private interface SampleRepository extends Repository<Person, String> {
		...
		List<Person> listByQuery(@ParamQuery NestedQuery query);
	}
